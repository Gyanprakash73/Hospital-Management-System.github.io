...
<html>
  ...
  <body>
    <table class="table table-bordered">
      ...
      <tr bgcolor=red>
        <td ><font size=4 color=white>Save Appointments</font></td>
      </tr>
      ...
      if($error==0)
      {
        ...
        echo "<tr><td align=center><font size=4 color=green>Successfully Appointment Booked</font></td></tr>";
      }
      else
      {
        echo "<form name=fdadd method=post action=ABOOKSAVE.php>";
        echo "<tr><td><table width=750 cellspacing=0 cellpadding=5>";
            ...
            echo "<tr><td>Doctor Id & Name</td><td><select name=doc style='width:230px'>";
      ...
      ?>
      <tr>
        <td align=center><a href="../index.html">Continue...</a></td>
      </tr>
    </table>
  </body>
</html>